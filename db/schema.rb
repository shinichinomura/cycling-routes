...
ActiveRecord::Schema.define(version: 20160429155636) do
  ...
  create_table "article_destinations", force: :cascade do |t|
  ...
  add_index "article_destinations", ["article_id"], name: "index_article_destinations_on_article_id", using: :btree
  add_index "article_destinations", ["destination_id"], name: "index_article_destinations_on_destination_id", using: :btree
  ...
  add_index "destination_spots", ["destination_id"], name: "index_destination_spots_on_destination_id", using: :btree
  add_index "destination_spots", ["spot_id"], name: "index_destination_spots_on_spot_id", using: :btree
  ...
  add_foreign_key "article_destinations", "articles"
